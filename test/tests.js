...
describe('Library', function() {
	...
	it('should merge string and create assets files', function() {
		...
		expect(fs.existsSync(path.join(path.dirname(undefined), 'simpleharSrc'))).to.be(true);
		expect(fs.existsSync(path.join(path.dirname(undefined), 'simpleharSrc', 'script.js'))).to.be(true);
		expect(fs.existsSync(path.join(path.dirname(undefined), 'simpleharSrc', 'stupidtable.js'))).to.be(true);
		expect(fs.existsSync(path.join(path.dirname(undefined), 'simpleharSrc', 'style.css'))).to.be(true);
	});
